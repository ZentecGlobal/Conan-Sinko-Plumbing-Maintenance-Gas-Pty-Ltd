...
export default function FaqAccordion({ items }: FaqAccordionProps) {
  ...
  return (
    <div className="divide-y divide-border overflow-hidden rounded-3xl border border-border bg-surface shadow-[0_2px_8px_rgba(28,36,57,0.06),0_12px_24px_rgba(28,36,57,0.06)]">
